...
exports.createOfferLetter = void 0;
const PDFDocument = require("pdfkit");
const createOfferLetter = (application) => {
    ...
    doc
        .fontSize(11)
        .font("Helvetica")
        .text(`We are pleased to extend this formal offer of employment for the position of ${job.title} at ${job.company}.`, { align: "left" })
        .moveDown(1);
    doc.text("After reviewing your qualifications and interview performance, we believe you will be a valuable addition to our team. Your experience and expertise align perfectly with our organizational values.", { align: "left" })
        .moveDown(1.5);
    // ========== JOB DETAILS SECTION ==========
    doc
        .fontSize(12)
    ...
    doc
        .fontSize(11)
        .font("Helvetica")
        .text(`We look forward to welcoming you to the ${job.company} team and working together towards mutual growth and success. Please confirm your acceptance of this offer at your earliest convenience.`, { align: "left" })
        .moveDown(2);
    // ========== SIGNATURE SECTION ==========
    doc
        .fontSize(11)
    ...
    doc
        ...
        .text("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━", { align: "center" })
        .moveDown(0.3);
    doc.text("This offer letter is valid for 14 days from the date of issue. Please contact HR for any clarifications.", { align: "center" })
        .moveDown(0.3);
